...
class RepositoryHelper(val jdbcTemplate: JdbcTemplate) {
    ...
    fun <T> jdbcQueryGetList(query: () -> String,
                             params: PreparedStatement.() -> Unit,
                             mapper: (ResultSet, Any?) -> T): List<T> {
        return jdbcTemplate.query({
            with(it.prepareStatement(query.invoke())) {
                params.invoke(this)
                this
    ...
    fun updateJdbc(query: () -> String, params: PreparedStatement.() -> Unit): Int {
    ...
    fun insertWithReturnKeyJdbc(query: () -> String, params: PreparedStatement.() -> Unit): Long? {
