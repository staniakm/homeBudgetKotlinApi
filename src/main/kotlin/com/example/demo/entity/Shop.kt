...
val shopSummaryRowMapper: (row: Row, metadata: RowMetadata) -> ShopSummary = { row, _ ->
    ShopSummary(row["id"] as Int, row["name"] as String, row["monthSum"] as BigDecimal, row["yearSum"] as BigDecimal)
}
