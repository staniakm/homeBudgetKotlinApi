...
class InvoiceRepositoryTest(@Autowired private val invoiceRepository: InvoiceRepository) : IntegrationTest() {
    ...
    fun `should fetch invoice details`() {
        ...
        invoiceDetails shouldContain ShopCartDetails(1, "aso1", "1.000".toBigDecimal(), "1.01".toBigDecimal(),"0.00".toBigDecimal(), "1.01".toBigDecimal(), 1)
        invoiceDetails shouldContain ShopCartDetails(2, "aso2", "2.000".toBigDecimal(), "1.02".toBigDecimal(),"0.00".toBigDecimal(), "2.01".toBigDecimal(), 2)
        invoiceDetails shouldContain ShopCartDetails(3, "aso3", "3.000".toBigDecimal(), "1.03".toBigDecimal(),"1.10".toBigDecimal(), "3.01".toBigDecimal(), 3)
    }
